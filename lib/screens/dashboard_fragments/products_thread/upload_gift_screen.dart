...
class UploadGiftScreen extends ConsumerStatefulWidget {
  const UploadGiftScreen({super.key});
  // this.selectedImages});
  // final List<AssetEntity>? selectedImages;
  @override
  ConsumerState<UploadGiftScreen> createState() => _UploadGiftScreenState();
}

class _UploadGiftScreenState extends ConsumerState<UploadGiftScreen> {
